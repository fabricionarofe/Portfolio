# 🔌 WP Plugin: Cotações Financeiras — WordPress Financial Quotes Plugin
...
**WordPress Plugin Standard Headers** (in wp-plugin-cotacoes.php):
`php
/**
...
Supported currencies in the mock: USD, EUR, GBP.
...
2. Copy the wp-plugin-cotacoes folder to your WordPress plugins directory:
   `
   C:\xampp\htdocs\your-wordpress-site\wp-content\plugins\wp-plugin-cotacoes\
   `
3. Open your WordPress admin panel at http://localhost/your-wordpress-site/wp-admin.
4. Navigate to **Plugins** → Find **"Cotações Financeiras (Portfólio Sênior)"** → Click **Activate**.

### Option B — ZIP Upload
1. Compress the wp-plugin-cotacoes folder into a .zip file.
