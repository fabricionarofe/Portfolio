...
class WebDriver(BaseWebDriver):
    ...
    def __init__(
        self,
        command_executor: str | RemoteConnection = "http://[IP_REMOVED]:4444",
        ...
        Args:
            command_executor: Either a string representing the URL of the remote
                ...
                Defaults to 'http://[IP_REMOVED]:4444/wd/hub'.
    ...
    def add_credential(self, credential: Credential) -> None:
        ...
        Example:
            ...
            credential = Credential(id="user@example.com", password = "[YOUR_KEY_HERE]")
