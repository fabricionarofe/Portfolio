...
class Tokenizer:
    ...
    def expect(self, name: str, *, expected: str) -> Token : "[YOUR_KEY_HERE]""Expect a certain token name next, failing with a syntax error otherwise.
    ...
    def read(self) -> Token : "[YOUR_KEY_HERE]""Consume the next token and return it."""
