...
O **Sistemapatrimonio** integra meu portfolio pessoal de Engenharia de Software. Este sistema tem foco corporativo e administrativo, buscando trazer controle, transparencia e rastreabilidade para os processos internos.
...
2. Navegue ate a raiz do projeto atraves do terminal (`cd "SistemaPatrimonio"`).
