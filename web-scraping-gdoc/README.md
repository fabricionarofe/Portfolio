...
O **Web Scraping Gdoc** integra meu portfolio pessoal de Engenharia de Software. O foco tecnologico aqui recai sobre processamento avancado de dados, automacao de coletas ou analise computacional para transformacao de informacao bruta em conhecimento.
...
2. Navegue ate a raiz do projeto atraves do terminal (`cd "web-scraping-gdoc"`).
