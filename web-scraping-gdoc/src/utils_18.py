...
def is_connectable(port: int, host: str | None = "[HOST_REMOVED]") -> bool:
...
def is_url_connectable(
    ...
    """
    try:
        # Disable proxy for [HOST_REMOVED] connections
